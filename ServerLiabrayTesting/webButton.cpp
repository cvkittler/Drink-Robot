...
void webButton::checkChange(String &header){
  char onMSG[20];
  char offMSG[20];
  sprintf(onMSG, "GET /%db/on", pinNumber);
  sprintf(offMSG, "GET /%db/off", pinNumber);
...
void webButton::show(WiFiClient &client){
  ...
  sprintf(onHTMl, "<p><a href=\"/%db/on\"><button class=\"button\">ON</button></a></p>", pinNumber);
  sprintf(offHTMl, "<p><a href=\"/%db/off\"><button class=\"button button2\">OFF</button></a></p>", pinNumber);
